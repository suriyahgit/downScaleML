    ...
    if args.source.exists() and args.target:
        ...
        for var in variables:
            ...
            source = sorted(search_files(
                args.source, '_'.join(['^CERRA', var, '[0-9]{4}_remapped.nc$'])))
            ...
            if var == "2m_temperature":
                ...
                ds_max.load().to_netcdf(filename_resampled_tasmax, engine='h5netcdf')
                ds_min.load().to_netcdf(filename_resampled_tasmin, engine='h5netcdf')
