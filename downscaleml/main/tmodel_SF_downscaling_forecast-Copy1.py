...
if __name__ == '__main__':
    ...
    prediction = np.ones(shape=(predictand_valid.shape[2], predictand_valid.shape[1], predictand_valid.shape[0], len(predictors_valid["number"]))) * np.nan
    
    models = np.ones(shape=(predictors_train.shape[0], predictors_train.shape[1]))*np.nan
